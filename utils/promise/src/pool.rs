...
lazy_static! {
    ...
    pub static ref PROMISE_POOL_SIZE: GenericGauge<AtomicU64> =
        GenericGauge::new("promise_thread_pool_size", "Total size of this thread pool.")
    ...
    R: Send + 'static,
{
    ...
    #[cfg(any(windows, target_os = "linux", target_os = "macos"))]
    {
        ...
        fn init_pool() -> Pool {
            ...
            PROMISE_POOL_SIZE.set(init_size);
