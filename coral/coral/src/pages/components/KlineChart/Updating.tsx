...
import { withUpdatingData, withOHLCData } from "@/pages/components/data";
...
export const Updating = withOHLCData("SECONDS")(
    withUpdatingData()(withSize({ style: { minHeight: 400 } })(withDeviceRatio()(BasicLineSeries))),
);
